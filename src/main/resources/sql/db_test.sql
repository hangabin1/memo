...
insert into student(student_code, name, gender, major_code,birth,phone) values('s12', '정오빈', 'M', 'm3','20030202', '01000000021');
...
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone) VALUES('s14', '김동현', 'M', 'm4', '20030202', '01000000020'),
                                                                                ('s15', '박은진', 'F', 'm1', '20030202', '01000000020');
...
insert into student values('s0', '안될애', '20202020', 'M', '010929292929', 'm1');
...
-- 간단하고 코드가 짧고, 빠르게 작성 가능. 하지만 복잡해지면 가독성 떨어진다. 다양한 조인 방식을 사용할 수 없다.
select s.name, s.major_code, m.major_name
